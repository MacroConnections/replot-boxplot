(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["BoxPlot"] = factory(require("react"));
	else
		root["BoxPlot"] = factory(root["React"]);
...
var _BoxPlot = __webpack_require__(15);

var _BoxPlot2 = _interopRequireDefault(_BoxPlot);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _BoxPlot2.default;
...
var _Distribution = __webpack_require__(28);

var _Distribution2 = _interopRequireDefault(_Distribution);

var _replotCore = __webpack_require__(29);
...
var Plot = function (_React$Component) {
  ...
  function Plot(props) {
    ...
    _this.state = {
      spread: _this.props.initialAnimation ? false : true
    };
    return _this;
  }
    ...
    value: function render() {
      ...
      if (!this.state.spread) {
        return _react2.default.createElement(
          "g",
          null,
          _react2.default.createElement("line", { x1: -this.props.width / 2 + this.props.offset, y1: positions.medY,
      ...
      return _react2.default.createElement(
        _reactMotion.Motion,
        {
          ...
          style: {
            maxY: (0, _reactMotion.spring)(positions.maxY, { stiffness: 50, damping: 12 }),
            q4Y1: (0, _reactMotion.spring)(positions.q4Y1, { stiffness: 50, damping: 12 }),
            q4Y2: (0, _reactMotion.spring)(positions.q4Y2, { stiffness: 50, damping: 12 }),
            rectY: (0, _reactMotion.spring)(positions.rectY, { stiffness: 50, damping: 12 }),
            rectHeight: (0, _reactMotion.spring)(positions.rectHeight, { stiffness: 50, damping: 12 }),
            medY: (0, _reactMotion.spring)(positions.medY, { stiffness: 50, damping: 12 }),
            cY: (0, _reactMotion.spring)(positions.cY, { stiffness: 50, damping: 12 }),
            q0Y1: (0, _reactMotion.spring)(positions.q0Y1, { stiffness: 50, damping: 12 }),
            q0Y2: (0, _reactMotion.spring)(positions.q0Y2, { stiffness: 50, damping: 12 }),
            minY: (0, _reactMotion.spring)(positions.minY, { stiffness: 50, damping: 12 })
          }
        },
...
var PlotContainer = function (_React$Component2) {
  _inherits(PlotContainer, _React$Component2);
  ...
  _createClass(PlotContainer, [{
    ...
    value: function render() {
      var plots = [];
      var unit = this.props.height / (this.props.max + this.props.padding - (this.props.min - this.props.padding));

      var plotWidth = this.props.width / this.props.distributions.length / 2;

      for (var i = 0; i < this.props.distributions.length; i++) {
        plots.push(_react2.default.createElement(Plot, { key: "plot" + i, distribution: this.props.distributions[i], width: plotWidth,
...
var BoxPlot = function (_React$Component3) {
  _inherits(BoxPlot, _React$Component3);

  function BoxPlot() {
    _classCallCheck(this, BoxPlot);

    var _this5 = _possibleConstructorReturn(this, (BoxPlot.__proto__ || Object.getPrototypeOf(BoxPlot)).call(this));
  ...
  _createClass(BoxPlot, [{
    ...
    key: "colorPlot",
    value: function colorPlot(i, group) {
    ...
    value: function draw(distributions, min, max, labels) {
      ...
      graph = _react2.default.createElement(
        _replotCore.Axis,
        { key: "axis", graphTitle: this.props.graphTitle, width: this.props.width,
    ...
    value: function render() {
      ...
      if (this.props.groupKey) {
        unique = [].concat(_toConsumableArray(new Set(this.props.data.map(function (item) {
      ...
      var series = this.draw(distributions, min, max, unique);
...
var BoxPlotResponsive = function (_React$Component4) {
  _inherits(BoxPlotResponsive, _React$Component4);

  function BoxPlotResponsive() {
    _classCallCheck(this, BoxPlotResponsive);

    return _possibleConstructorReturn(this, (BoxPlotResponsive.__proto__ || Object.getPrototypeOf(BoxPlotResponsive)).apply(this, arguments));
  }

  _createClass(BoxPlotResponsive, [{
    key: "render",
    value: function render() {
      return _react2.default.createElement(
        _replotCore.Resize,
        { width: this.props.width },
        _react2.default.createElement(BoxPlot, this.props)
      );
    }
  }]);

  return BoxPlotResponsive;
}(_react2.default.Component);
...
var _TransitionMotion = __webpack_require__(24);
...
var _presets = __webpack_require__(13);
...
var _mergeDiff = __webpack_require__(25);
